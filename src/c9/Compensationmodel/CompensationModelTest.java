...
public class CompensationModelTest {
    public static void main(String[] args) {
        ...
        Employee employee3 = new Employee("Inu", "Dem", "678-9672", new CommissionCompensationModel(10.6,  100));
        ...
        employee2.setCompensationModel(new CommissionCompensationModel(4000, 0.7));
